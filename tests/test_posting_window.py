...
class PostingWindowTest(unittest.TestCase):
    ...
    def test_explicit_slot_allows_delayed_jst_8_01am(self) -> None:
    ...
    def test_explicit_slot_allows_delayed_jst_12_59pm(self) -> None:
        dt = datetime(2026, 3, 31, 12, 59, 0, tzinfo=JST)
        self.assertTrue(should_run_in_posting_window(dt, allowed_times=[(8, 0), (12, 30), (21, 0)]))

    def test_explicit_slot_rejects_next_hour_after_jst_12_30pm(self) -> None:
        dt = datetime(2026, 3, 31, 13, 0, 0, tzinfo=JST)
        self.assertFalse(should_run_in_posting_window(dt, allowed_times=[(8, 0), (12, 30), (21, 0)]))
